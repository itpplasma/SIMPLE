...
!  use_B_r=.false.
    use_B_r = .true.
    !important for plotting, not needed for canonical coordinates
    use_del_tp_B = .false.
  !not very important (saves 1 iteration in coord. transform), do not use to save memory
!  use_del_tp_B=.true.
!
...
!
            call splint_boozer_coord(r, vartheta_B, varphi_B, 2, &
...
!
            isw = 0
            call delthe_delphi_BV(isw, r, vartheta_B, varphi_B, deltheta_BV, &
                                  delphi_BV, &
...
!
        call splint_boozer_coord(r + eps, vartheta_B, varphi_B, 2, &
                                 A_theta, A_phi_p, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
...
!
        call splint_boozer_coord(r - eps, vartheta_B, varphi_B, 2, &
                                 A_theta, A_phi_m, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
...
!
        ...
        d2B_vartheta_B_num = (B_vartheta_B_p + B_vartheta_B_m - &
                              2.d0*B_vartheta_B)/eps**2
...
!
!
        call splint_boozer_coord(r, vartheta_B + eps, varphi_B, 2, &
                                 A_theta, A_phi_p, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
                                 B_vartheta_B_p, dB_vartheta_B, d2B_vartheta_B, &
...
!
!
        call splint_boozer_coord(r, vartheta_B, varphi_B + eps, 2, &
                                 A_theta, A_phi_p, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
                                 B_vartheta_B_p, dB_vartheta_B, d2B_vartheta_B, &
...
!
!
        call splint_boozer_coord(r + eps, vartheta_B + eps, varphi_B, 2, &
                                 A_theta, A_phi_p, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
                                 B_vartheta_B_p, dB_vartheta_B, d2B_vartheta_B, &
...
!
!
        call splint_boozer_coord(r + eps, vartheta_B, varphi_B + eps, 2, &
                                 A_theta, A_phi_p, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
                                 B_vartheta_B_p, dB_vartheta_B, d2B_vartheta_B, &
...
!
!
        call splint_boozer_coord(r, vartheta_B + eps, varphi_B + eps, 2, &
                                 A_theta, A_phi_p, dA_theta_dr, dA_phi_dr, &
                                 d2A_phi_dr2, &
                                 d3A_phi_dr3, &
                                 B_vartheta_B_p, dB_vartheta_B, d2B_vartheta_B, &
