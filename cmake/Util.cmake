...
function(find_or_fetch DEPENDENCY)
    if(DEFINED ${DEPENDENCY}_SOURCE_DIR)
        get_filename_component(_${DEPENDENCY}_ABS "${${DEPENDENCY}_SOURCE_DIR}" ABSOLUTE BASE_DIR ${CMAKE_SOURCE_DIR})
        set(${DEPENDENCY}_SOURCE_DIR ${_${DEPENDENCY}_ABS})
        message(STATUS "Using ${DEPENDENCY} in ${${DEPENDENCY}_SOURCE_DIR}")
    elseif(DEFINED ENV{CODE})
        get_filename_component(_${DEPENDENCY}_ABS "$ENV{CODE}/${DEPENDENCY}" ABSOLUTE)
        set(${DEPENDENCY}_SOURCE_DIR ${_${DEPENDENCY}_ABS})
        message(STATUS "Using ${DEPENDENCY} in ${${DEPENDENCY}_SOURCE_DIR}")
    else()
