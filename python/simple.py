...
def trace_particles(vmec_file, particles, tmax=100.0, integrator='midpoint', **kwargs):
    """
...
def sample_surface(vmec_file, n_particles, s=0.9, **kwargs):
    """
    ...
    """
    # Use existing Fortran surface sampling
    config = {
        'vmec_file': str(vmec_file),
...
def sample_volume(vmec_file, n_particles, s_inner=0.1, s_outer=0.9, **kwargs):
    """
...
def load_particles(vmec_file, particle_file, **kwargs):
    """
