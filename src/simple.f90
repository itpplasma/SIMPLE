...
public
  ...
  type :: tracer_t
    ...
    integer :: integmode = 0 ! 0 = RK, 1 = Euler1, 2 = Euler2, 3 = Midpoint, 4-7 = Gauss1-4, 15 = Lobatto3, 20 = Gauss-Radau, 21 = Bulirsch-Stoer, 22 = Cash-Karp, 24 = TDRK (fixed step), 25 = TDRK (adaptive)
    real(dp) :: relerr
