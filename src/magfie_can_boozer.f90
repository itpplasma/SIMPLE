...
!                                        along $\bB$
     !                     hcurl(3)         - contra-variant components of curl of $\bh$
        ...
        bder(1) = 0.5d0*((dA_theta_dr*dB_varphi_c_dr - dA_phi_dr*dB_vartheta_c_dr - &
                          d2A_phi_dr2*B_vartheta_c) &
                         /bmod2 - dsqg_c_dr)/sqg_c
        bder(2) = 0.5d0*((dA_theta_dr*dB_varphi_c_dt - &
                          dA_phi_dr*dB_vartheta_c_dt)/bmod2 - &
                         dsqg_c_dt)/sqg_c
        bder(3) = 0.5d0*((dA_theta_dr*dB_varphi_c_dp - &
                          dA_phi_dr*dB_vartheta_c_dp)/bmod2 - &
                         dsqg_c_dp)/sqg_c
        ...
        hcurl(1) = ((dB_varphi_c_dt - dB_vartheta_c_dp)/bmod - bder(2)*hcovar(3) + &
                    bder(3)*hcovar(2))/sqg_c
